...
export default function DemoPage() {
  ...
  const t = lang === "fr" ? {
    ...
    behaviorLabel: "Comportement observe", behaviorPlaceholder: "ex: 3 visites en 5 jours, pricing page revue, whitepaper SOC2 lu jusqu'au bout, demande de démo abandonnee à l'etape 2",
    ...
    retargetedMock: "Audience LinkedIn Ads creee : COO scale-up SaaS B2B (mode démo)",
