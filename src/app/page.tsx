...
const P = {
  ...
  metrics: [
    ...
    { value: "360deg", label: "vue client unifiee" },
  ...
  testimonials: [
    { quote: "En trois semaines, notre taux de conversion sur les pages produit a augmente de 34%. PersonaAI a identifie des segments qu'on n'avait jamais vus dans nos analytics.", author: "Camille R.", role: "Head of Growth, E-commerce Mode" },
    { quote: "On personnalise maintenant l'email, le site et les push notifications avec le meme profil. Le ROI est mesurable des le premier mois.", author: "Thomas B.", role: "CMO, Marketplace B2C" },
  ],
        ...
        <div style={{ maxWidth:860, margin:"0 auto" }}>
          <div style={{ textAlign:"center", marginBottom:48 }}>
            ...
            <h2 style={{ fontSize:"clamp(1.8rem,3.5vw,2.8rem)", fontWeight:700, color:txt1, letterSpacing:"-0.02em", fontFamily:"'Instrument Serif',Georgia,serif" }}>
              En place en <em style={{ fontStyle:"italic", color:accent }}>moins d&apos;une heure</em>
            </h2>
          </div>
