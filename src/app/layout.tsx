...
export const metadata: Metadata = { title:"PersonaAI — Profiling client IA en temps reel", description:"PersonaAI analyse les comportements de vos visiteurs en temps reel et delivre des recommandations ultra-personnalisees pour maximiser la conversion." };
